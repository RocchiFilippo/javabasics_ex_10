...
public class Main {
    ...
    private static void exercise3() {
        ...
        //Write your code here
        double ourTestPercentage = (100 * ourTestScore)/maxTestScore;


        if (!isTestRetry)
        {
            if (ourTestPercentage >= 90) {
                System.out.println("A");
            } else if (ourTestPercentage >= 80) {
                System.out.println("B");
            } else if (ourTestPercentage >= 70) {
                System.out.println("C");
            } else if (ourTestPercentage >= 60) {
